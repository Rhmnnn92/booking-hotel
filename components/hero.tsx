  ...
  return (
    <div className="relative h-screen text-white overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center text-center items-center h-full">
            <h1 className="text-7xl font-extrabold leading-tight mb-3 capitalize">Book your Best Rooms</h1>
            <p className="text-xl text-gray-300 mb-8">Get spesial offer, Just Today.</p>
