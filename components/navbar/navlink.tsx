...
{!open ? <IoMenu className="size-8" /> : <IoClose className="size-8" />}
        ...
        {/* supaya beda di desktop dan mobile */}
...
<li>
<Link href="/admin/room" className="block py-2 px-3 text-gray-800 hover:bg-gray-100 rounded-sm md:hover:bg-transparent md:p-0">Manage Rooms</Link>
</li>
